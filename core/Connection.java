...
public abstract class Connection {
	...
	/**
	 * Returns toNode in the other end of the connection
	 * @return The requested DTN Host
	 */
	...
	/**
	 * Returns fromInterface in the other end of the connection
	 * @return The requested interface
	 */
	...
	/**
	 * Returns toInterface in the other end of the connection
	 * @return The requested interface
	 */
