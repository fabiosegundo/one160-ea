 ...
 */
public class InterferenceLimitedWifiInterface extends NetworkInterface {
	protected int currentTransmitSpeed;
	protected int numberOfTransmissions;

	public InterferenceLimitedWifiInterface(Settings s) {
		super(s);
	 ...
	 */
	public InterferenceLimitedWifiInterface(InterferenceLimitedWifiInterface ni) {
		super(ni);
	...
	public NetworkInterface replicate() {
		return new InterferenceLimitedWifiInterface(this);
	}
	...
	public void update() {
		...
		if (isActive()) {	
			...
			for (Connection con : this.connections) {
				...
				if (((InterferenceLimitedWifiInterface)con.getOtherInterface(this)).
						isTransferring() == true) {
					numberOfActive++;
				}
			}
	...
	public String toString() {
		return "InterfaceLimitedWifiInterface " + super.toString();
	}
