 ...
 */
public class InterferenceLimitedBtInterface extends NetworkInterface {
	protected int currentTransmitSpeed;
	protected int numberOfTransmissions;

	public InterferenceLimitedBtInterface(Settings s) {
		super(s);
	 ...
	 */
	public InterferenceLimitedBtInterface(InterferenceLimitedBtInterface ni) {
		super(ni);
	...
	public NetworkInterface replicate() {
		return new InterferenceLimitedBtInterface(this);
	}
	...
	public void update() {
		...
		if (isActive()) {
			...
			for (Connection con : this.connections) {
				...
				if (((InterferenceLimitedBtInterface)con.getOtherInterface(this)).
						isTransferring() == true) {
					numberOfActive++;
				}
			}
	...
	public String toString() {
		return "InterfaceLimitedBtInterface " + super.toString();
	}
